<template>
  <div>
    <el-button v-permission="permission.resetPwd" size="mini" type="primary" icon="el-icon-refresh-right" @click="resetPwd(data)" />
    <el-button v-permission="permission.resetPwd" size="mini" type="primary" icon="el-icon-key" @click="updatePwd(data)" />
