    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <el-table-column label="异常详情" width="100px">
        <template slot-scope="scope">
          <el-button v-permission="permission.details" size="mini" type="text" @click="info(scope.row.id)">查看详情</el-button>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  data() {
    return {
      ...
      permission: {
        del: ['admin', 'errorlogs:del'],
        details: ['admin', 'errorlogs:details']
      }
    }
  },
  created() {
